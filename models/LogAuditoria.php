...
class LogAuditoria extends Model
{
    ...
    public function paginar(array $filtros, ?int $empresaId, int $pagina, int $porPagina = 25): array
    {
        ...
        foreach (['usuario_id'=>'usuario_id','acao'=>'acao','tabela_afetada'=>'tabela_afetada'] as $entrada=>$coluna) if (!empty($filtros[$entrada])) { $sql.=" AND l.$coluna=:$entrada"; $p[$entrada]=$filtros[$entrada]; }
