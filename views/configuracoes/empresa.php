<div class="modulo-cabecalho"><div><h1><i class="fa-solid fa-building-gear"></i> Configurações da empresa</h1><p>Personalize as preferências visuais e de notificações da sua empresa.</p></div></div>
<form method="post" action="<?php echo URL_BASE; ?>/configuracoes/guardar" class="config-form">
    ...
    <section class="config-cartao">
        <div class="config-cartao-cabecalho"><div class="config-cartao-icone"><i class="fa-solid fa-bell"></i></div><h2>Notificações</h2></div>
        <div class="config-grid">
            <?php foreach(['notificacoes_email'=>'Notificações por e-mail','notificacoes_sistema'=>'Notificações no sistema'] as $k=>$l): ?>
