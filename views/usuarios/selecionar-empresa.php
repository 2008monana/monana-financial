<?php
/**
 * Seleção de Empresa - Utilizadores
 * Com contagem de utilizadores por empresa
 * Mesmo visual e estilo que Filiais
 */
?>
...
<div class="page-header">
    <div>
        ...
        <p class="page-subtitle">Selecione a empresa para gerir os utilizadores</p>
    </div>
</div>
...
<?php if (empty($empresas)): ?>
    <div class="empty-state">
        ...
        <p>Não existem empresas ativas no sistema. Crie uma empresa para começar.</p>
            ...
            <a href="<?php echo URL_BASE; ?>/usuarios/index?empresa_id=<?php echo $empresa['id']; ?>" 
               ...
               style="--card-color: <?php echo $cor['bg']; ?>; --card-light: <?php echo $cor['light']; ?>;">
                ...
                <div class="selection-info">
                    ...
                    <div class="selection-details">
                        <span class="detail-item">
                            ...
                            <?php echo htmlspecialchars($empresa['email_contacto'] ?: 'Sem e-mail'); ?>
                        </span>
                        ...
                        <?php if ($empresa['nif']): ?>
                            <span class="detail-item">
                                ...
                                <?php echo htmlspecialchars($empresa['nif']); ?>
                            </span>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="selection-card-bottom">
                    ...
                    <span class="selection-status <?php echo $empresa['ativa'] ? 'active' : 'inactive'; ?>">
